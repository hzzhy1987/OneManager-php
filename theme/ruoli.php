...
<head>
    ...
    <style type="text/css">
        body{
            ...
            font-size:16px;/**文字字体 */
            line-height:1em;/**行高 */
            background-image:url("https://api.ixiaowai.cn/api/api.php");/*背景图片*/
            color:#33FF7F;/*文字颜色*/ 
            }
        a{
            color:#33FF7F;/**设置超链接颜色 */
            cursor:pointer;/**设置超链接鼠标指针*/
            text-decoration:none;/**取消超链接下划线 */
            }
        a:hover{
            color:#33FF7F;/**设置鼠标指向超链接颜色 */
            }
        textarea{
            color:#33FF7F;/**textarea字体颜色 */
            background:rgba(85,85,85,0.8)/**textarea背景颜色 */
        }
        .login ion-icon{vertical-align:bottom}
        .changelanguage{
            position:absolute;
            right:5px;
            filter:alpha(opacity=0);opacity:0;/**把语言选项透明度改100% */
            }
        .title{
            text-align:center;
            margin-top:1rem;
        ...
        .list-header-container .table-header{
            ...
            font-weight:400;
            color:#33FF7F;
            background-color:rgba(51,51,51,0.8);/**文件列表导航条背景颜色 */
            }
        .list-body-container{
            position:relative;
            left:0;
            ...
            background:rgba(85,85,85,0.8)/**文件列表背景颜色 */
            }
        .list-table{
            width:100%;
            padding:20px;
        ...
        .list-table tr[data-to]:hover{
            background-color:rgba(211,211,211,0.8);/**设置文件列表被选中背景颜色 */
            }
        .list-table tr:first-child{
            background:rgba(51,51,51,0.5);/**文件列表标题背景颜色 */
            }
...
<?php } ?>
        ...
        .readme{
            padding:8px;
            background-color:rgba(85,85,85,0.8);/**设置readme和head背景色 */
            }
...
<?php   }
    ...
    <div id="footer" color="#f7f7f9">Powered by <!--<a href="http://wpa.qq.com/msgrd?v=3&uin=2909998156&site=qq&menu=yes">-->若离<!--</a>--></div><!--底部版权修改-->
</body>
