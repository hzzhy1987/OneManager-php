...
<head>
    ...
    background-image:url("https://api.ixiaowai.cn/api/api.php");
        ...
        body{font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;font-size:14px;line-height:1em;background-color:#f7f7f7;color:#000}
        ...
        .list-container,.list-header-container,.list-wrapper,a.back-link:hover,body{color:#FFFFFF}
        .list-header-container .table-header{
            ...
            font-weight:400;
            color:#FFFFFF;
            background-color:rgba(85,85,85,0.5);/**文件列表导航条背景颜色 */
            }
        .list-body-container{
            position:relative;
            left:0;
            ...
            background:rgba(85,85,85,0.5);/**文件列表背景颜色 */
            }
        ...
        .list-table tr[data-to]:hover{background:rgba(85,85,85,0.5)}
...
<?php } ?>
        ...
        .readme{
            padding:8px;
            background-color:rgba(85,85,85,0.5);/**设置readme和head背景色 */
            }
...
<?php   }
    ...
    <center><div style="color:#0cd1e8;"><?php  echo date("Y-m-d H:i:s")." ".getconstStr('Week')[date("w")]." ".$_SERVER['REMOTE_ADDR'];?></div></center>
</body>
<?php if ($files) { ?>
