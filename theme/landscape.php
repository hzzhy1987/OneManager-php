...
<head>
    ...
    <style type="text/css">
        body{font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;font-size:14px;line-height:1em;color:#000;background-image:url('https://api.ooopn.com/image/bing/api.php?v=2&type=jump');background-size:cover;background-size:100%;background-attachment:fixed}
        a {
	color:#FFFFFF;
	cursor:pointer;
