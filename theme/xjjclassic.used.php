...
<?php } ?>
            ...
            <div class="password"><form method="post" action="https://www.baidu.com/s?wd=">
    <!-- search query --> <input type="text" name="q"  placeholder="在此输入文件名按回车键进行搜索" size="30"/>
...
<hr/><br/><br/><br/><hr/>提示:<p align="left">**您的IP是:<?php echo " ".$_SERVER['REMOTE_ADDR'];?><br/>**请勿上传违反中国大陆和香港法律的文件,违者后果自负！本站有权向公安举报协助净化网络环境.<br/>**因上传前所有文件都会经腾讯云自动审查,违规文件被删后,无法找回,请保护好个人重要隐私文件!<br/>**上传无格式限制，图片类无水印,原图保存.支持代码、图片、文本文件即时预览,音视频播放.游客上传最大支持4M,密匙上传无限制,均支持断点续传！</p>
<!--<pre>
API地址：
https://pan.isoyu.com/uploads/api.php
--------
API输入：
...
';
            ...
            echo '
	            ...
	            <center><h4>输入密码进行查看Help:admin@isoyu.com</h4>
...
(function() {
  ...
  hm.src = "https://hm.baidu.com/hm.js?f030edbbf553047a87b0142bf265370f";
...
<!--<script type="text/javascript" charset="UTF-8" src="https://api.isoyu.com/js/v1.js" exte-id="548" data-size="36x140" data-color="#FF7119" data-show="1"></script>

            <a href="https://isoyu.com/sitemap/" target="_blank">SiteMap</a>
            <a href="https://isoyu.com/spider.html" target="_blank">INSObot</a>
            <a href="https://api.isoyu.com/" target="_blank">Docker Api</a>
			<a href="https://isoyu.com/about/Index1.html" target="_blank">Privacy<!-- (en - en_gb - object) --></a>
			<!--<a href="https://isoyu.com/about/Index20.html" target="_blank">About</a>
			<a href="https://t.me/INS_O" target="_blank">F.A.Q.</a>
		    <a href="javascript:;">© 2007-2019 isoyu.com. All Rights Reserved.</a>-->
</div>
