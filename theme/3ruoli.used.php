...
<head>
    ...
    <style type="text/css">
        body{font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;font-size:14px;line-height:1em;background-image:url("https://api.ixiaowai.cn/api/api.php");color:#00bc8c;}
        a{color:#00bc8c;cursor:pointer;text-decoration:none}
		th,td,path,input,button,span{color: #00bc8c;}
		#mask{text-align: center; color:#00bc8c ;}
        .title{text-align:center;margin-top:1rem;letter-spacing:2px;margin-bottom:2rem}
        .title a{color:#00bc8c;text-decoration:none}
        ...
        .list-header-container .table-header{margin:0;border:0 none;padding:30px 60px;text-align:left;font-weight:400;color:#00bc8c;background-color:#f7f7f9;filter:alpha(Opacity=80);-moz-opacity:0.8;opacity: 0.8;}
        .list-body-container{position:relative;left:0;overflow-x:hidden;overflow-y:auto;box-sizing:border-box;background:#fff;filter:alpha(Opacity=80);-moz-opacity:0.8;opacity: 0.8;}
        .list-table{width:100%;padding:20px;border-spacing:0}
        .list-table tr{height:40px}
        .list-table tr[data-to]:hover{background:#f1f1f1;filter:alpha(Opacity=80);-moz-opacity:0.8;opacity: 0.8;}
        .list-table tr:first-child{background:#fff;filter:alpha(Opacity=80);-moz-opacity:0.8;opacity: 0.8;}
...
<?php } ?>
        ...
        .readme{padding:8px;background-color:#fff;filter:alpha(Opacity=80);-moz-opacity:0.8;opacity: 0.8;}
...
<?php                       if ($_SERVER['admin']) { ?>
                            ...
                            <ul>
								...
								<li><a class="operate_ul_li" href="?RefreshCache">
								<img alt="" class="operate_ico operate_ico_refreshcache"/>
								<?php echo getconstStr('RefreshCache'); ?></a>
								</li>
...
<?php   }
    ...
    <div id="mask" color="#f7f7f9"><?php echo date("Y-m-d H:i:s")." ".getconstStr('Week')[date("w")]." ".$_SERVER['REMOTE_ADDR'];?></div>
</body>
