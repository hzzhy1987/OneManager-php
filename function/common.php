...
function needUpdate()
{
    ...
    $github_version = file_get_contents('https://raw.githubusercontent.com/qkqpttgf/OneManager-php/proxydownload/version');
...
function render_list($path = '', $files = '')
{
    ...
    $html = '<!--
    Github ： https://github.com/ldxw/OneManager-php/tree/proxydownload
-->' . ob_get_clean();
